...
@AllArgsConstructor
@Data
public class AccRecordViewDto {

	// [ AccRecordViewDto 클래스 ]
	// 사고감지 정보를 기반으로 기록관리 게시판에 저장되는 기록 데이터 클래스
	
	// ㅇ 게시판 목록에 필요한 데이터
	private int recordId;       						// 게시글 번호 (acc_record 테이블 PK)
    private String recordTitle; 						// 게시글 제목
    private final String detectionType = "사고 감지";		// 탐지 유형
